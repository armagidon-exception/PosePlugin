...
import ru.armagidon.poseplugin.api.wrappers.*;
...
public class FakePlayerProtocolized extends FakePlayer
{
    ...
    public FakePlayerProtocolized(Player parent, Pose pose) {
        ...
        metadataAccessor = new MetadataAccessorProtocolized(this);
        npcUpdater = FakePlayerSynchronizer.createNew(this);
        customEquipmentManager = FakePlayerCustomEquipmentManager.createNew(this);
