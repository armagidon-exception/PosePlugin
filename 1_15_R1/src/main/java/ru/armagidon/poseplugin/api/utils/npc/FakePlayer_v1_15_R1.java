...
public class FakePlayer_v1_15_R1 implements FakePlayer, Listener
{
    ...
    public FakePlayer_v1_15_R1(Player parent, Pose pose) {
        this.pose = pose;
        this.parent = parent;
        ...
        this.metadataAccessor = new MetadataAccessorImpl_v1_15_R1(this);
        //Set metadata
        setMetadata();
        this.npcUpdater = new FakePlayerUpdaterImpl_v1_15_R1(this);

        this.customEquipmentManager = new CustomEquipmentManagerImpl_v1_15_R1(this);
    ...
    public void initiate() {
        ...
        PosePluginAPI.getAPI().getTickingBundle().addToTickingBundle(FakePlayer_v1_15_R1.class, this);
    ...
    public void destroy() {
        trackers.clear();
        PosePluginAPI.getAPI().getTickingBundle().removeFromTickingBundle(FakePlayer_v1_15_R1.class, this);
