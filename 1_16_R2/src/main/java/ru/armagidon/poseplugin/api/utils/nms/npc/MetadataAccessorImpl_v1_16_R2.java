...
public class MetadataAccessorImpl_v1_16_R2 implements MetadataAccessor
{
    ...
    public MetadataAccessorImpl_v1_16_R2(FakePlayer_v1_16_R2 npc) {
        this.npc = npc;
    ...
    @Override
    public boolean whichHandIsMain() {
