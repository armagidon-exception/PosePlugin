...
import ru.armagidon.poseplugin.api.utils.nms.item.ItemUtil_v1_16_R2;
...
import static ru.armagidon.poseplugin.api.utils.nms.npc.FakePlayer_v1_16_R2.FakePlayerStaff.getEquipmentBySlot;
import static ru.armagidon.poseplugin.api.utils.nms.npc.FakePlayer_v1_16_R2.FakePlayerStaff.getFixedRotation;

public class FakePlayerUpdaterImpl_v1_16_R2 implements FakePlayerUpdater {
    ...
    public FakePlayerUpdaterImpl_v1_16_R2(FakePlayer_v1_16_R2 npc) {
        this.npc = npc;
        this.pOverlays = ((EntityPlayer)asNMSCopy(npc.getParent())).getDataWatcher().get(DataWatcherRegistry.a.a(16));
        this.util = new ItemUtil_v1_16_R2(new org.bukkit.inventory.ItemStack(Material.AIR));
    }
