...
import static ru.armagidon.poseplugin.api.utils.nms.npc.FakePlayer_v1_16_R2.FakePlayerStaff.*;
...
public class FakePlayer_v1_16_R2 implements FakePlayer, Listener
{
    ...
    FakePlayer_v1_16_R2(Player parent, Pose pose) {
        this.pose = pose;
        this.parent = parent;
        ...
        this.metadataAccessor = new MetadataAccessorImpl_v1_16_R2(this);
        //Set metadata
        setMetadata();
        this.npcUpdater = new FakePlayerUpdaterImpl_v1_16_R2(this);

        this.customEquipmentInterface = new CustomEquipmentInterfaceImpl_v1_16_R2(this);
