...
import static ru.armagidon.poseplugin.api.utils.npc.FakePlayer_v1_16_R1.FakePlayerStaff.getEquipmentBySlot;
import static ru.armagidon.poseplugin.api.utils.npc.FakePlayer_v1_16_R1.FakePlayerStaff.getFixedRotation;

public class FakePlayerSynchronizerImpl_v1_16_R1 implements FakePlayerSynchronizer {

    private final FakePlayer_v1_16_R1 npc;

    private byte pOverlays;

    public FakePlayerSynchronizerImpl_v1_16_R1(FakePlayer_v1_16_R1 npc) {
        this.npc = npc;
